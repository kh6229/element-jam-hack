...
const LevelScript level_bob_entry[] = {
	...
	AREA(2, bob_area_2),
		...
		WARP_NODE(0x0C, LEVEL_BOB, 0x02, 0x0C, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_CHILL_FLAME, 53, -4931, -4074, 0, 0, 0, 0x00000000, bhv1Up),
		OBJECT(MODEL_DEAD_VINE, 53, -4931, -3423, 0, 0, 0, 0x00000000, bhvDeadVine),
