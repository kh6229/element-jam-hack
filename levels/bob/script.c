...
const LevelScript level_bob_entry[] = {
	...
	AREA(2, bob_area_2),
		...
		WARP_NODE(0x0D, LEVEL_BOB, 0x03, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_DEAD_VINE, 342, -8035, 2054, 0, -90, 11, 0x00000000, bhvDeadVine),
		OBJECT(MODEL_DEAD_VINE, -265, -9104, 4121, -90, 0, -7, 0x00010000, bhvDeadVine),
		OBJECT(MODEL_DEAD_VINE, 2, -9104, 5598, -90, 0, -46, 0x00010000, bhvDeadVine),
		...
		OBJECT(MODEL_NONE, 263, -8497, 6502, 0, 0, 0, 0x04000000, bhvHiddenStar),
		...
		OBJECT(MODEL_NONE, 105, -8992, 8175, 0, 0, 0, 0x320D0000, bhvWarp),
		...
		OBJECT(MODEL_NONE, 105, -8687, 6856, 0, 0, 0, 0x000E0000, bhvTextTrigger),
	...
	AREA(3, bob_area_3),
		...
		WARP_NODE(0x0A, LEVEL_BOB, 0x02, 0x0D, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_CASTLE_GROUNDS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_HEART, -3, 3117, -1327, 0, 0, 0, 0x00000000, bhvRecoveryHeart),
		OBJECT(MODEL_LAVA_POOL, 0, -2167, -587, 0, 0, 0, 0x00000000, bhvLavaPool),
		OBJECT(MODEL_NONE, 322, -580, -232, 0, 0, 0, 0x00600000, bhvPoleGrabbing),
		OBJECT(MODEL_NONE, -755, 1598, -432, 0, 0, 0, 0x00600000, bhvPoleGrabbing),
		OBJECT(MODEL_NONE, -3, 1598, 280, 0, 0, 0, 0x00600000, bhvPoleGrabbing),
		OBJECT(MODEL_NONE, -738, 3513, -947, 0, 0, 0, 0x00600000, bhvPoleGrabbing),
		OBJECT(MODEL_NONE, 0, -1958, -6310, 0, 0, 0, 0x000A0000, bhvWarp),
		OBJECT(MODEL_NONE, 0, 11775, -587, 0, 0, 0, 0x640B0000, bhvWarp),
		OBJECT(MODEL_NONE, 0, -2285, -4574, 0, 0, 0, 0x000F0000, bhvTextTrigger),
